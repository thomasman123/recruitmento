          ...
          {currentStep === 2 && (
            <div className="space-y-4">
                  ...
                  {[
                    ...
                    <div key={industry} className="flex items-center space-x-2">
                      <Checkbox
                        ...
                        onCheckedChange={(checked) => handleCheckboxChange("industries", industry, checked as boolean)}
                      />
                ...
                <div className="grid grid-cols-2 gap-2">
                  {[
                    ...
                    <div key={skill} className="flex items-center space-x-2">
                      <Checkbox
                        id={`skill-${skill}`}
                        checked={formData.salesSkills.includes(skill)}
                        onCheckedChange={(checked) => handleCheckboxChange("salesSkills", skill, checked as boolean)}
                      />
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-2 gap-2">
                  {["English", "Spanish", "French", "German", "Mandarin", "Japanese", "Portuguese", "Other"].map(
                    (language) => (
                      <div key={language} className="flex items-center space-x-2">
                        <Checkbox
                          id={`language-${language}`}
                          checked={formData.languages.includes(language)}
                          onCheckedChange={(checked) => handleCheckboxChange("languages", language, checked as boolean)}
                        />
                  ...
                  {["Full-time", "Part-time", "Contract", "Freelance", "Internship", "Temporary"].map((jobType) => (
                    <div key={jobType} className="flex items-center space-x-2">
                      <Checkbox
                        ...
                        onCheckedChange={(checked) => handleCheckboxChange("jobTypes", jobType, checked as boolean)}
                      />
